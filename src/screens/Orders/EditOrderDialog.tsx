...
const EditOrderDialog: React.FC<Props> = ({ onClose, orderId }) => {
  ...
  return (
    <MuiPickersUtilsProvider utils={DayUtils}>
      <Dialog open aria-labelledby="dialog-title" onClose={onClose}>
        ...
        >
          ...
          <DialogActions>
            ...
            <LoadingButton
              ...
              disabled={
                !formState.isDirty || !!Object.keys(formState.errors).length || editOrder.isLoading
              }
              type="submit"
